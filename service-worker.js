const cacheName = "meteo-france-v66";
const shell = ["/runtime-config.js?v=2.054", "/changelog.html", "/", "/index.html", "/style.css?v=92", "/app.js?v=119", "/manifest.webmanifest", "/vendor/leaflet/leaflet.css", "/vendor/leaflet/leaflet.js"];
