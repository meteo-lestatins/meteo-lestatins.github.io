const cacheName = "meteo-france-v86";
const shell = ["/about.html", "/architecture.svg", "/echelle-kilometrique.css?v=8", "/echelle-kilometrique.js?v=11", "/runtime-config.js?v=2.102", "/changelog.html", "/", "/index.html", "/style.css?v=124", "/app.js?v=158", "/manifest.webmanifest", "/vendor/leaflet/leaflet.css", "/vendor/leaflet/leaflet.js"];
