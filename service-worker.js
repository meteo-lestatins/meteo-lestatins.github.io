const cacheName = "meteo-main-v2-104";
const shell = ["/about.html", "/architecture.svg", "/echelle-kilometrique.css?v=8", "/echelle-kilometrique.js?v=11", "/runtime-config.js?v=2.104", "/changelog.html", "/", "/index.html", "/style.css?v=124", "/app.js?v=159", "/manifest.webmanifest", "/vendor/leaflet/leaflet.css", "/vendor/leaflet/leaflet.js"];
