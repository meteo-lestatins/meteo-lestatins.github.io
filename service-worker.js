const cacheName = "meteo-france-v68";
const shell = ["/runtime-config.js?v=2.057", "/changelog.html", "/", "/index.html", "/style.css?v=94", "/app.js?v=121", "/manifest.webmanifest", "/vendor/leaflet/leaflet.css", "/vendor/leaflet/leaflet.js"];
