const cacheName = "meteo-main-v3-089-r1";
const shell = ["/about.html", "/architecture.svg", "/echelle-kilometrique.css?v=10", "/echelle-kilometrique.js?v=14", "/runtime-config.js?v=3.089", "/changelog.html", "/", "/index.html", "/style.css?v=153", "/app.js?v=206", "/analytics.js?v=1", "/manifest.webmanifest", "/vendor/meteo-france-vigilance-sprites.png", "/contact/", "/contact/index.html", "/contact/contact.css?v=4", "/contact/contact.js?v=1", "/news/", "/news/index.html", "/news/news.css?v=2", "/news/markdown.js?v=1", "/news/news.js?v=3"];
