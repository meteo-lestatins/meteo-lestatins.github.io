const cacheName = "meteo-main-v3-247-r1";
const shell = ["/pictogrammes/carte-radar.png?v=2", "/about.html", "/architecture.svg", "/echelle-kilometrique.css?v=14", "/echelle-kilometrique.js?v=15", "/runtime-config.js?v=3.247", "/changelog.html", "/", "/index.html", "/style.css?v=175", "/app.js?v=240", "/analytics.js?v=4", "/manifest.webmanifest", "/vendor/vigilance-icons/phenomenon-1.png", "/vendor/vigilance-icons/phenomenon-2.png", "/vendor/vigilance-icons/phenomenon-3.png", "/vendor/vigilance-icons/phenomenon-4.png", "/vendor/vigilance-icons/phenomenon-5.png", "/vendor/vigilance-icons/phenomenon-6.png", "/vendor/vigilance-icons/phenomenon-7.png", "/vendor/vigilance-icons/phenomenon-8.png", "/vendor/vigilance-icons/phenomenon-9.png", "/contact/", "/contact/index.html", "/contact/contact.css?v=4", "/contact/contact.js?v=1", "/news/", "/news/index.html", "/news/news.css?v=2", "/news/markdown.js?v=1", "/news/news.js?v=3"];
