const cacheName = "meteo-sandbox-b20260815064609504";
const shell = ["/sandbox/about.html", "/sandbox/architecture.svg", "/sandbox/echelle-kilometrique.css?v=8", "/sandbox/echelle-kilometrique.js?v=11", "/sandbox/runtime-config.js?v=2.103", "/sandbox/changelog.html", "/sandbox/", "/sandbox/index.html", "/sandbox/style.css?v=124", "/sandbox/app.js?v=159", "/sandbox/manifest.webmanifest", "/sandbox/vendor/leaflet/leaflet.css", "/sandbox/vendor/leaflet/leaflet.js"];
