const cacheName = "meteo-sandbox-v1";
const shell = ["/sandbox/runtime-config.js?v=2.057", "/sandbox/changelog.html", "/sandbox/", "/sandbox/index.html", "/sandbox/style.css?v=94", "/sandbox/app.js?v=121", "/sandbox/manifest.webmanifest", "/sandbox/vendor/leaflet/leaflet.css", "/sandbox/vendor/leaflet/leaflet.js"];
