const cacheName = "meteo-sandbox-v8";
const shell = ["/sandbox/runtime-config.js?v=2.061", "/sandbox/changelog.html", "/sandbox/", "/sandbox/index.html", "/sandbox/style.css?v=97", "/sandbox/app.js?v=127", "/sandbox/manifest.webmanifest", "/sandbox/vendor/leaflet/leaflet.css", "/sandbox/vendor/leaflet/leaflet.js"];
