const cacheName = "meteo-sandbox-v64";
const shell = ["/sandbox/about.html", "/sandbox/architecture.svg", "/sandbox/echelle-kilometrique.css?v=8", "/sandbox/echelle-kilometrique.js?v=11", "/sandbox/runtime-config.js?v=2.095", "/sandbox/changelog.html", "/sandbox/", "/sandbox/index.html", "/sandbox/style.css?v=123", "/sandbox/app.js?v=155", "/sandbox/manifest.webmanifest", "/sandbox/vendor/leaflet/leaflet.css", "/sandbox/vendor/leaflet/leaflet.js"];
